...
### Phase 6: scroll セッション化と段階変化

**対応 Issue**
- I-03

**主目的**
- scroll を単発イベント列ではなくセッションとして扱い、継続時間や変化量に応じて音の段階を変える
...
- Phase 6 は Phase 4 / 5 完了後に開始する
- Phase 7 は Phase 2 〜 6 の制御対象が揃ってから行う
- Phase 8 は MVP の妨げにならないよう後置する
- Phase 9 は全期間を通じて更新するが、実装目的としては最後に整理する
...
6. Phase 6 を単独で完了させる
7. Phase 7 を単独で完了させる
8. Phase 8 を判断フェーズとして実施する
9. Phase 9 は全期間を通じて更新し、節目ごとに計画とレビュー運用を整理する
