...
### A-03: 低遅延・多重再生に対応した audio 基盤が未実装

- 現状は単一 `AVAudioPlayer` の差し替えで音が途中中断される
- 音声を再生のたびにロードしており、入力追従性が不足している
- Klack 系アプリに近い one-shot 感が出ていない
